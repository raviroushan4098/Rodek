...
const simpleRoutes = [
    ...
    { path: '/api/bookings/agreement', file: 'api/_routes/bookings/agreement.js' },
    { path: '/api/public/accept-agreement', file: 'api/_routes/public/accept-agreement.js' },
    { path: '/api/public/get-agreement', file: 'api/_routes/public/get-agreement.js' },
